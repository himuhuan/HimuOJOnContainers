...
public static class AppHostDefaults
{
    ...
    public static WebApplicationBuilder CreateBootstrapBuilder(string[] args,
        string serviceName, string apiVersion, bool showLogo = true)
    {
        ...
        Log.Information("Now starting HimuOJ {serviceName} {apiVersion}  ...", serviceName, apiVersion);
        if (showLogo)
        {
