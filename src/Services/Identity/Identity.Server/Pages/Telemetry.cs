...
#pragma warning disable CA1724 // Type names should not match namespaces
    ...
    public static class Telemetry
    {
        ...
        public static class Metrics
        {
            ...
            private static Counter<long> ConsentCounter =
                Meter.CreateCounter<long>(Counters.Consent);

            private static Counter<long> GrantsRevokedCounter =
                Meter.CreateCounter<long>(Counters.GrantsRevoked);

            private static Counter<long> UserLoginCounter =
                Meter.CreateCounter<long>(Counters.UserLogin);

            private static Counter<long> UserLogoutCounter =
                Meter.CreateCounter<long>(Counters.UserLogout);
